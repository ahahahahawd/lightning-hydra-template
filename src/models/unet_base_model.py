...
from src.models.modules.unet_parts import (
    DoubleConv, Down, DownUseConv, Up, OutConv,
    DownUseConv,
    ResBlock,
    )
...
class UNetDCLitModel(LightningModule):
    """
    UNetDC
    Based on the UNetLitModel
    Replace maxpool(2) with conv stride 2 in Down block
    ...
    def __init__(
        ...
        self.inc = DoubleConv(in_c, 64)
        self.down1 = DownUseConv(64, 128)
        self.down2 = DownUseConv(128, 256)
        self.down3 = DownUseConv(256, 512)
        factor = 2 if bilinear else 1
        self.down4 = DownUseConv(512, 1024 // factor)
        self.up1 = Up(1024, 512 // factor, bilinear)
        self.up2 = Up(512, 256 // factor, bilinear)
        self.up3 = Up(256, 128 // factor, bilinear)
        self.up4 = Up(128, 64, bilinear)
